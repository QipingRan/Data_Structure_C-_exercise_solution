// The previous exercise describes the function replace. 
// This operation exists outside of the ADT bag; that is, it is not an ADT bag operation. 
// Instead, its implementation is written in terms of the ADT bag’s operations.

// What is an advantage and a disadvantage of the way that replace is implemented?

// What is an advantage and a disadvantage of adding the operation replace to the ADT bag?
